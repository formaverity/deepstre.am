...
export default function DrawerFrame({ project }) {
  ...
  return (
    <div
      className={`frame-drawer-overlay${visible ? ' frame-drawer-overlay--visible' : ''}`}
      onClick={handleOverlayClick}
    >
      <div className="frame-drawer-panel">
        ...
        <div className="frame-placeholder">
          <span>coming soon — this will be a side drawer</span>
